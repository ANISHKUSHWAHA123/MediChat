...
<style>
    ...
    .chat-message.user {
        bachground-color: #2b313e;
        color:white;
    }
    .chat_message-assistant {
        bachground-color: #f0f2f6;
        color:black;
    }
    .chat-message .avatar {
        width:2rem;
...
<div style="text-align: center; padding: 2rem 0;">
    <h1 style="color: #ff4b4b; font-size: 3rem; margin-bottom: 0.5rem;">🏥 MediChat</h1>
    ...
    if st.session_state.vectorstore and st.session_state.chat_model:
        with st.chat_message("assistant"):
            with st.spinner("🔍 Searching documents..."):
                ...
                Based on the following medical documents, provide accurate and helpful answer.
                If the information is not in the documents, clearlystate that.
...
st.markdown("""
    <div style="text-align: center; color: #666; font-size: 0.9rem;">
        <p>🏥 Medical Document Intelligence | 🤖 Powered by Euri AI & LangChain</p>
    </div>          
""", unsafe_allow_html=True)